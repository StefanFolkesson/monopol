...
namespace monopol {
    internal class ChanceSpace : BoardSpace{
        
        public ChanceSpace(string name, int position) : base(name, position) {
        }
        ...
        public void HandleAction(GamePlayer currentPlayer,  Card card) {
            ...
            Debug.WriteLine($"{currentPlayer.Name} draws a chance card.");
            switch (card.Action) {
                case "directadvance":
